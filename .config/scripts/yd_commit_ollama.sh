...
prompt="Provide ONLY a very short and concise commit message summarizing these changes based on folders mainly (ideally under 50 characters). No formating of any kind. Changes: $staged_changes."
